...
# Unit tests for src/platforms/muos/continuity_daemon.sh
...
. "$PROJECT_ROOT/src/platforms/muos/continuity_daemon.sh"
...
ln -s "$PROJECT_ROOT/src/platforms/muos/pal_muos.sh" "$FAKE_PAK/scripts/pal_muos.sh"
ln -s "$PROJECT_ROOT/src/platforms/muos/enroll_sd_card.sh" "$FAKE_PAK/scripts/enroll_sd_card.sh"
...
cd_write_pid
rc=0
( CONTINUITY_APP_DIR="$FAKE_PAK"; cd_load_modules ) 2>/dev/null || rc=$?
...
cd_write_pid
rc=0
( CONTINUITY_APP_DIR="$FAKE_PAK"; cd_load_modules ) 2>"$TEST_TMPDIR/crlf_err.txt" || rc=$?
...
CONTINUITY_APP_DIR="$BB_PAK" CONTINUITY_DAEMON_SELF="$BB_SELF" cd_reexec_busybox
...
mk_fake_bb 0 0
CONTINUITY_BB_STATUS=""
CONTINUITY_VENDOR_SH=0 CONTINUITY_APP_DIR="$BB_PAK" CONTINUITY_DAEMON_SELF="$BB_SELF" cd_reexec_busybox
...
rc=0
( CONTINUITY_APP_DIR="$BB_PAK" CONTINUITY_DAEMON_SELF="$BB_SELF" \
...
CONTINUITY_BB_STATUS=""
rm -f "$TEST_TMPDIR/bb_exec_args"
CONTINUITY_BB_REEXEC=1 CONTINUITY_APP_DIR="$BB_PAK" CONTINUITY_DAEMON_SELF="$BB_SELF" cd_reexec_busybox
